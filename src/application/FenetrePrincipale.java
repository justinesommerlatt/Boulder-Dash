...
public class FenetrePrincipale extends Application {
	...
	/**
	 * Associe chaque objet a son image
	 */
	...
	/**
	 * Dessine la grille avec les images associes
	 */
	...
	/**
	 * Permet de deplacer Rockford avec les fleches du clavier
	 */
	...
	/**
	 * Applique la gravite toute les 1 sec
	 */
	...
	/**
	 * Affiche les scores en haut de la fenetre
	 * @throws MalformedURLException
	 */
	private void initHeader() throws MalformedURLException {
		panneauHeader = new PanneauHeader(plateau.getRF());
		((BorderPane) root).setTop(panneauHeader);
		
	}

	/**
	 * Affiche le temps ecoule en bas de la fenetre
	 */
